#!/usr/bin/env bun
/**
 * ip-whitelist-gateway - IP whitelist gateway with CIDR support
...
program.name("ip-whitelist-gateway").description("IP whitelist gateway with CIDR support").version("1.0.0")
